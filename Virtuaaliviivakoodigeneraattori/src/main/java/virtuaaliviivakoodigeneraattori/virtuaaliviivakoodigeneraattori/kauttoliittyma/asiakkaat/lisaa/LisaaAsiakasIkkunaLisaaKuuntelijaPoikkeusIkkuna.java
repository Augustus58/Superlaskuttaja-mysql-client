 ...
 * @author Augustus58
 */
public class LisaaAsiakasIkkunaLisaaKuuntelijaPoikkeusIkkuna implements Runnable {
    ...
    private void luoKomponentit(Container container) {
        ...
        okButton.addActionListener(new LisaaAsiakasIkkunaLisaaKuuntelijaPoikkeusIkkunaOkKuuntelija(dialog));
