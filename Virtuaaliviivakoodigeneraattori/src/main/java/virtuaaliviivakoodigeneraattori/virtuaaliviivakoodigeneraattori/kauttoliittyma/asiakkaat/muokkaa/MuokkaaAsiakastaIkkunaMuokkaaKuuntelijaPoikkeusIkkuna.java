 ...
 * @author Augustus58
 */
public class MuokkaaAsiakastaIkkunaMuokkaaKuuntelijaPoikkeusIkkuna implements Runnable {
    ...
    private void luoKomponentit(Container container) {
        ...
        okButton.addActionListener(new MuokkaaAsiakastaIkkunaMuokkaaKuuntelijaPoikkeusIkkunaOkKuuntelija(dialog));
