 ...
 * @author Augustus58
 */
public class LaskutPanelLisaaLaskuPoikkeusIkkuna implements Runnable {
    ...
    private void luoKomponentit(Container container) {
        ...
        okButton.addActionListener(new LaskutPanelLisaaLaskuPoikkeusIkkunaOkKuuntelija(dialog));
