 ...
 * @author Augustus58
 */
public class LaskutPanelLisaaLaskuPoikkeusIkkunaOkKuuntelija implements ActionListener {
    private final JDialog dialog;

    public LaskutPanelLisaaLaskuPoikkeusIkkunaOkKuuntelija(JDialog dialog) {
        this.dialog = dialog;
    }
