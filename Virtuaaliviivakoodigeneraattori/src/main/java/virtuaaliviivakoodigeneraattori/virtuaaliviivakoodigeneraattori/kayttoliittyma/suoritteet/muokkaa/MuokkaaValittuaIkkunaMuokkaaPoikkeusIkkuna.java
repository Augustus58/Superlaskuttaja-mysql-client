...
import virtuaaliviivakoodigeneraattori.virtuaaliviivakoodigeneraattori.kayttoliittyma.suoritteet.lisaaValitusta.*;
 ...
 * @author Augustus58
 */
public class MuokkaaValittuaIkkunaMuokkaaPoikkeusIkkuna implements Runnable {
    ...
    private void luoKomponentit(Container container) {
        ...
        okButton.addActionListener(new MuokkaaValittuaIkkunaMuokkaaPoikkeusIkkunaOkKuuntelija(dialog));
