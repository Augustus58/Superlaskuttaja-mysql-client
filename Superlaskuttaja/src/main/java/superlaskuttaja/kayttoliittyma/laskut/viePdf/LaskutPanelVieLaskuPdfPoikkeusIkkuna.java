 ...
 * @author Augustus58
 */
public class LaskutPanelVieLaskuPdfPoikkeusIkkuna implements Runnable {
    ...
    private void luoKomponentit(Container container) {
        ...
        okButton.addActionListener(new LaskutPanelVieLaskuPdfPoikkeusIkkunaOkKuuntelija(dialog));
