 ...
 * @author Augustus58
 */
public class MuokkaaLaskuaIkkunaMuokkaaLaskuaPoikkeusIkkuna implements Runnable {
    ...
    private void luoKomponentit(Container container) {
        ...
        okButton.addActionListener(new MuokkaaLaskuaIkkunaMuokkaaLaskuaPoikkeusIkkunaOkKuuntelija(dialog));
