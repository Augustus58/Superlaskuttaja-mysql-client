 ...
 * @author Augustus58
 */
public class LaskutPanelMuokkaaLaskuaPoikkeusIkkuna implements Runnable {
    ...
    private void luoKomponentit(Container container) {
        ...
        okButton.addActionListener(new LaskutPanelMuokkaaLaskuaPoikkeusIkkunaOkKuuntelija(dialog));
