 ...
 * @author Augustus58
 */
public class LaskutPanelMVMaksettuPoikkeusIkkuna implements Runnable {
    ...
    private void luoKomponentit(Container container) {
        ...
        okButton.addActionListener(new LaskutPanelMVMaksettuPoikkeusIkkunaOkKuuntelija(dialog));
