 ...
 * @author Augustus58
 */
public class MuokkaaLaskuttajanTietojaIkkunaMuokkaaPoikkeusIkkuna implements Runnable {
    ...
    private void luoKomponentit(Container container) {
        ...
        okButton.addActionListener(new MuokkaaLaskuttajanTietojaIkkunaMuokkaaPoikkeusIkkunaOkKuuntelija(dialog));
