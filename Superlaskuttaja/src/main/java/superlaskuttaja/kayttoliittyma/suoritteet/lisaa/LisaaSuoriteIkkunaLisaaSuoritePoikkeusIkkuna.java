 ...
 * @author Augustus58
 */
public class LisaaSuoriteIkkunaLisaaSuoritePoikkeusIkkuna implements Runnable {
    ...
    private void luoKomponentit(Container container) {
        ...
        okButton.addActionListener(new LisaaSuoriteIkkunaLisaaSuoritePoikkeusIkkunaOkKuuntelija(dialog));
