 ...
 * @author Augustus58
 */
public class LisaaSuoriteValitustaIkkunaLisaaSuoritePoikkeusIkkuna implements Runnable {
    ...
    private void luoKomponentit(Container container) {
        ...
        okButton.addActionListener(new LisaaSuoriteValitustaIkkunaLisaaSuoritePoikkeusIkkunaOkKuuntelija(dialog));
