 ...
 * @author Augustus58
 */
public class LisaaSuoriteValitustaIkkunaAloitusAikaKenttaKuuntelija implements DocumentListener {
    ...
    public LisaaSuoriteValitustaIkkunaAloitusAikaKenttaKuuntelija() {
