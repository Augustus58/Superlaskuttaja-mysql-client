 ...
 * @author Augustus58
 */
public class LisaaSuoriteValitustaIkkunaLopetusAikaKenttaKuuntelija implements DocumentListener {
    ...
    public LisaaSuoriteValitustaIkkunaLopetusAikaKenttaKuuntelija() {
