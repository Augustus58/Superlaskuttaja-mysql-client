 ...
 * @author Augustus58
 */
public class LisaaSuoriteValitustaIkkunaVerotonAHintaKenttaKuuntelija implements DocumentListener {
    ...
    public LisaaSuoriteValitustaIkkunaVerotonAHintaKenttaKuuntelija() {
