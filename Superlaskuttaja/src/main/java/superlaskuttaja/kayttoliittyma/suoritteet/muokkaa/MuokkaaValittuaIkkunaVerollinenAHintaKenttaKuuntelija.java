 ...
 * @author Augustus58
 */
public class MuokkaaValittuaIkkunaVerollinenAHintaKenttaKuuntelija implements DocumentListener {
    ...
    public MuokkaaValittuaIkkunaVerollinenAHintaKenttaKuuntelija() {
