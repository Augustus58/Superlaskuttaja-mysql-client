...
public class MuokkaaValittuaIkkunaMuokkaaKuuntelija implements ActionListener {
    ...
    public MuokkaaValittuaIkkunaMuokkaaKuuntelija(JComboBox tilaajaComboBox, JComboBox vastaanottajaComboBox, TilaajaComboBoxKuuntelija tilaajaComboBoxKuuntelija, ComboBoxKuuntelija vastaanottajaComboBoxKuuntelija, JTextField kuvausKentta, JTextField aloitusAikaKentta, JTextField lopetusAikaKentta, JTextField maaraKentta, JTextField maaranYksikotKentta, JTextField aHintaVerotonKentta, JTextField alvProsKentta, DataDeliver lataaja, SuoritteetTaulukko taulukko, JFrame frame, NappulaLukko lukko, Object[] objects, TaulukkoValintaKuuntelija taulukkoValintaKuuntelija) {
        ...
        this.taulukkoValintaKuuntelija = taulukkoValintaKuuntelija;
    ...
    public void actionPerformed(ActionEvent ae) {
        try {
            ...
            lataaja.getDbc().executeUpdate("REPLACE INTO Suorite () VALUES (\n"
                    + (Integer)objects[0] + ",\n"
                    + "NULL,\n"
                    + "'" + kuvausKentta.getText() + "',\n"
                    + tilaajaInt + ",\n"
            ...
            int suoritteenNumero = (Integer)objects[0];
            ...
            taulukko.addSuoritteetTaulukkoRiviKohtaan(taulukkoValintaKuuntelija.getPaivitettyArvo(), rs);
            taulukko.getModel().removeRow(taulukkoValintaKuuntelija.getPaivitettyArvo() + 1);
