...
public class MuokkaaValittuaIkkuna implements Runnable {
    ...
    public MuokkaaValittuaIkkuna(DataDeliver lataaja, SuoritteetTaulukko taulukko, NappulaLukko lukko, TaulukkoValintaKuuntelija kuuntelija) {
    ...
    public void run() {
        ...
        frame = new JFrame("Muokkaa valittua");
    ...
    private void luoKomponentit(Container container) {
        try {
            ...
            ResultSet rs1 = lataaja.getDbc().executeQuery("select distinct suoritteenNumero, kuvaus, tilaaja, tilaajanVersio, vastaanottaja, vastaanottajanVersio, maara, maaranYksikot, aHintaVeroton, alvProsentti, alkuaika, loppuaika, (1.24*aHintaVeroton) as aHintaVerollinen\n"
                    + "from Suorite\n"
            ...
            MuokkaaValittuaIkkunaAloitusAikaKenttaKuuntelija k1 = new MuokkaaValittuaIkkunaAloitusAikaKenttaKuuntelija();
            ...
            MuokkaaValittuaIkkunaLopetusAikaKenttaKuuntelija k2 = new MuokkaaValittuaIkkunaLopetusAikaKenttaKuuntelija();
            ...
            MuokkaaValittuaIkkunaMaaraKenttaKuuntelija k3 = new MuokkaaValittuaIkkunaMaaraKenttaKuuntelija();
            ...
            MuokkaaValittuaIkkunaVerollinenAHintaKenttaKuuntelija k4 = new MuokkaaValittuaIkkunaVerollinenAHintaKenttaKuuntelija();
            ...
            MuokkaaValittuaIkkunaVerotonAHintaKenttaKuuntelija k5 = new MuokkaaValittuaIkkunaVerotonAHintaKenttaKuuntelija();
